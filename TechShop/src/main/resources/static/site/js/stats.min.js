(function () {
  function d() {
    (i === "checkout_contact_view" || i === "checkout_all_view") &&
      ((n.value = Bizweb.Checkout.fbEvent ? Bizweb.Checkout.fbEvent.value : ""),
  ...
  function vt() {
    ...
    n.num_items = Bizweb.checkout.line_items.reduce(
      (n, { quantity: t }) => n + t,
      0
    );
      ...
      switch (i.url) {
        case "/cart/add.js":
          i.xhr.responseText &&
            ...
            (n.contents = [
              { id: e.variant_id, quantity: e.quantity, item_price: e.price },
            ]),
